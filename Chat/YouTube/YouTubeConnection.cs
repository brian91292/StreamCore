...
namespace StreamCore.YouTube
{
    public class YouTubeConnection
    {
        public static void Initialize()
        {
            ...
            RequestLiveBroadcastInfo();
        }

        internal static void RequestLiveBroadcastInfo(bool isRetry = false)
        {
            try
            {
                ...
                switch(((HttpWebResponse)ex.Response).StatusCode)
                {
                    ...
                    case HttpStatusCode.Unauthorized:
                        if (!isRetry)
                        {
                            ...
                            // If we get the new auth token successfully, remake this request
                            else
                                RequestLiveBroadcastInfo(true);
                        }
                        break;
